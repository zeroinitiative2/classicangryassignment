...
local AngryAssign_Version = 'v1.13.0'
...
function AngryAssign:UpdateDisplayed()
	...
	if page then
		...
		text = text:gsub("||", "|")
			...
			:gsub(ci_pattern('|cpriest'), "|ccfcc99ff")
			...
			:gsub(ci_pattern('|caction'), "|cffffcc33")
			:gsub(ci_pattern('|cability'), "|cff0066ff")
			:gsub(ci_pattern('|cheal'), "|cff99ffff")
			:gsub(ci_pattern('|cdps'), "|cffffff99")
			:gsub(ci_pattern('|ctank'), "|cffff9999")
			:gsub(ci_pattern('|catt'), "|ccfcc00ff")
...
--	elseif IsInRaid() then
	...
	if channel and page then
		...
		output = output:gsub("||", "|")
			...
			:gsub(ci_pattern('|caction'), "") 
			:gsub(ci_pattern('|cability'), "")
			:gsub(ci_pattern('|cheal'), "")
			:gsub(ci_pattern('|cdps'), "")
			:gsub(ci_pattern('|ctank'), "")
			:gsub(ci_pattern('|catt'), "")
